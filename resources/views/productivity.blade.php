    ...
    <div class="col-12">
      <div class="row align-items-center mb-2">
        <div class="col text-center">
          ...
          <p class="text-muted"><i>*double click in row table for view detail</i></p>
          <div class="row justify-content-center">
            <div class="col-3 ">
              <div id="reportrange" class="border px-5 py-2 bg-light mb-2 form-control" style="width: ">
                <i class="fe fe-calendar fe-16 mx-2"></i>
                <span>March 15, 2022 - April 13, 2022</span>
              </div>
              <form action="">
