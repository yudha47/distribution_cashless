<ul id="summary-status" class="nav nav-pills justify-content-start">
  ...
  <li class="nav-item">
    <a class="nav-link text-muted px-2" href="#">Send To Analyst <span class="badge badge-pill badge-danger ml-2" onclick="filter_status('Send To Analyst', 1)">{{$status1}}</span></a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-muted px-2" href="#">Send To MA <span class="badge badge-pill badge-danger ml-2" onclick="filter_status('Send To MA', 1)">{{$status2}}</span></a>
  </li>
